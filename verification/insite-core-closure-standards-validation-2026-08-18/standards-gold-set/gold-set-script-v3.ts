...
const GOLD_SET: GoldCase[] = [
  ...
  // ---- Added 2026-08-18 (pre-commit closure): rule-coverage gap adjudication (see FINAL_REPORT
  // PRE_COMMIT_RELEASE_CANDIDATE_CLOSURE). Sources: osha.gov (1926.34, 1910.178(p)(1)),
  // govinfo.gov 30 CFR part 62 (62.101/62.120/62.130) and part 47 (47.41).
  {
    id: 'CON-EGRESS-01', area: 'Construction - means of egress', regime: 'osha_construction',
    observation: 'In the occupied building under renovation on the jobsite, the ground-floor exit door is chained shut while twelve workers are on shift.',
    expectedCitations: ['1926.34'], mustNotReturn: ['1910.36'],
    authoritativeSource: 'osha.gov 29 CFR 1926.34(a) ("exits shall be so arranged and maintained as to provide free and unobstructed egress ... at all times when it is occupied")',
    rationale: 'Construction jurisdiction + occupied structure + required exit + exit locked/blocked. 1910.36 is General Industry only.',
  },
  {
    id: 'MSHA-NOISE-01', area: 'MSHA - noise above PEL', regime: 'msha',
    observation: 'A crusher operator at the surface mine has a measured 8-hour TWA noise exposure of 92 dBA with no hearing conservation program.',
    expectedCitations: ['62.120', '62.130'], mustNotReturn: ['1910.95', '1926.52'],
    authoritativeSource: 'govinfo.gov 30 CFR 62.101 (action level TWA8 85 dBA; PEL TWA8 90 dBA), 62.120, 62.130',
    rationale: 'MSHA jurisdiction + TWA8 92 dBA exceeds both the action level and the PEL. OSHA noise citations must not be offered as governing MSHA requirements.',
  },
  {
    id: 'MSHA-NOISE-02', area: 'MSHA - noise between action level and PEL', regime: 'msha',
    observation: 'A drill operator at the quarry has a measured 8-hour TWA noise exposure of 87 dBA.',
    expectedCitations: ['62.120'], mustNotReturn: ['62.130', '1910.95'],
    authoritativeSource: 'govinfo.gov 30 CFR 62.101, 62.120',
    rationale: '87 dBA TWA8 equals/exceeds the 85 dBA action level (HCP enrolment) but does not exceed the 90 dBA PEL, so 62.130 must not be returned as confirmed.',
  },
  {
    id: 'MSHA-NOISE-03-NEG', area: 'MSHA - noise below action level (negative control)', regime: 'msha',
    observation: 'A drill operator at the quarry has a measured 8-hour TWA noise exposure of 80 dBA.',
    expectedCitations: [], mustNotReturn: ['62.120', '62.130', '1910.95'],
    authoritativeSource: 'govinfo.gov 30 CFR 62.101',
    rationale: '80 dBA TWA8 is below the 85 dBA action level; a confident match would be a false positive.',
  },
  {
    id: 'MSHA-HAZCOM-01', area: 'MSHA - hazard communication container label', regime: 'msha',
    observation: 'A 55-gallon drum of solvent in the mine maintenance shop has no label identifying its contents or hazards.',
    expectedCitations: ['47.41'], mustNotReturn: ['1910.1200', '1926.59'],
    authoritativeSource: 'govinfo.gov 30 CFR 47.41(a) ("The operator must ensure that each container of a hazardous chemical has a label.")',
    rationale: 'MSHA jurisdiction + hazardous chemical container + label missing. OSHA HazCom must not be offered as the governing MSHA rule.',
  },
  {
    id: 'CON-LOTO-01-GAP', area: 'Construction - servicing without lockout (documented gap, honest empty)', regime: 'osha_construction',
    observation: 'On the construction site a laborer is servicing the concrete mixer with power connected and no lock or tag applied.',
    expectedCitations: [], mustNotReturn: ['1910.147', '56.12016'],
    authoritativeSource: 'Adjudicated 2026-08-18: 29 CFR 1926.417 covers tagging of electric circuits during work, not a general machinery servicing lockout requirement; no confident construction citation -- honest empty is the required behaviour (unsupported > wrong).',
    rationale: 'A confident GI (1910.147) or MSHA (56.12016) citation here would be a wrong-regime match; the finding remains a real hazard with no confirmed construction citation.',
  },
  {
