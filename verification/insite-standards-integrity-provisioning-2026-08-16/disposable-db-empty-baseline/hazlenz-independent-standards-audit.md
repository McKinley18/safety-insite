...
### msha-conveyor-jam-energized - critical-fail
...
Failures: Missing required primary/direct citation /56\.14107/i; active citations: none. | Missing required primary/direct citation /56\.12016/i; active citations: none.
...
### osha-gi-operating-unguarded-shaft - critical-fail
...
Failures: Missing required primary/direct citation /1910\.212/i; active citations: none.
...
### osha-gi-damaged-cord-wet-exposed - critical-fail
...
Failures: Missing required primary/direct citation /1910\.305|1910\.303|1910\.334/i; active citations: none.
...
Questions: Were internal conductors or energized parts exposed, or was the damage limited to the outer jacket? | What exact equipment, opening, edge, container, or travel path is involved? | Is the condition open, damaged, leaking, energized, obstructed, or otherwise uncontrolled? | Are workers exposed directly, or is the issue only a general concern without a specific hazard path?

Failures: none

### construction-edge-eight-feet - critical-fail
...
Questions: Was the issue a defective ladder, incorrect ladder use, an unprotected edge/opening, scaffold, roof, or platform? | What exact equipment, opening, edge, container, or travel path is involved? | Is the condition open, damaged, leaking, energized, obstructed, or otherwise uncontrolled? | Are workers exposed directly, or is the issue only a general concern without a specific hazard path?

Failures: Missing required primary/direct citation /1926\.501/i; active citations: none.

### osha-gi-same-level-trip - critical-fail
...
Failures: Missing required primary/direct citation /1910\.22/i; active citations: none.

### osha-gi-unlabeled-secondary-solvent - critical-fail
...
Failures: Missing required primary/direct citation /1910\.1200/i; active citations: none.
...
### msha-backup-alarm-reversing - critical-fail
...
Failures: Missing required primary/direct citation /56\.14132|56\.9100/i; active citations: none.
...
### permit-space-entry-positive - critical-fail
...
Failures: Missing required primary/direct citation /1910\.146/i; active citations: none.

### trench-deep-no-protection - critical-fail
...
Failures: Missing required primary/direct citation /1926\.652|1926\.651/i; active citations: none.
...
### construction-damaged-ladder - critical-fail
...
Failures: Missing required primary/direct citation /1926\.1053/i; active citations: none.

### multi-hazard-conveyor-and-oil - critical-fail
...
Failures: Missing required primary/direct citation /1910\.212/i; active citations: none. | Missing required primary/direct citation /1910\.22/i; active citations: none.
