...
const PACK_PATH = path.resolve(__dirname, '../../safescope-data/approved-knowledge/draft-candidates/mobile-equipment-pedestrian-traffic-control-draft-candidates.v1.json');
...
async function validate() {
  ...
  if (pack.packId !== "mobile-equipment-pedestrian-traffic-control-draft-candidates") {
  ...
  const keywords = ['mobile equipment', 'pedestrian', 'traffic'];
  ...
  console.log('✅ SafeScope mobile equipment pedestrian draft pack validation passed.');
}
