...
const PACK_PATH = path.resolve(__dirname, '../../safescope-data/approved-knowledge/draft-candidates/electrical-energized-equipment-draft-candidates.v1.json');
...
async function validate() {
  ...
  if (pack.packId !== "electrical-energized-equipment-draft-candidates") {
  ...
  const keywords = ['electrical', 'energized', 'cord', 'panel'];
