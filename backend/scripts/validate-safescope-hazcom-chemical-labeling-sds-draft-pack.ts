...
const PACK_PATH = path.resolve(__dirname, '../../safescope-data/approved-knowledge/draft-candidates/hazcom-chemical-labeling-sds-draft-candidates.v1.json');
...
async function validate() {
  ...
  if (pack.packId !== "hazcom-chemical-labeling-sds-draft-candidates") {
  ...
  const keywords = ['hazard_communication', 'chemical', 'label', 'sds', 'secondary_container', 'exposure'];
