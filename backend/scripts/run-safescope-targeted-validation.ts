...
const validatorGroups: Record<string, string[]> = {
    ...
    knowledge: [
        ...
        'validate-safescope-semantic-vector-search.ts',
        ...
        'validate-safescope-cryptographic-audit-trail.ts',
        ...
        'validate-safescope-reputable-sources.ts',
        'validate-safescope-multidisciplinary-expert.ts',
