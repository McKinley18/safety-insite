...
} from '../src/safescope-v2/expert-hazlenz/fixtures/expanded-validation-v4';
import {
...
const FIXTURES = 'backend/src/safescope-v2/expert-hazlenz/fixtures/expanded-validation-v4.ts';
