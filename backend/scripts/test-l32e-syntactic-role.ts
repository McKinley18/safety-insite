...
import { tokenRole, nounPhraseHead, hasContrastiveAfter, findTokenOccurrences } from '../src/hazlenz/reasoning-l3/predicate-role';
import { detectObservationGaps, observationAvailabilityOf } from '../src/hazlenz/reasoning-l3/observation-availability';
import { L3_SYSTEM_PROMPT, L3_PROMPT_VERSION } from '../src/hazlenz/reasoning-l3/reasoning-prompt';
