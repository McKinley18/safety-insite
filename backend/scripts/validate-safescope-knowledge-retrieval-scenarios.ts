...
const scenarios: Scenario[] = [
  ...
  {
    name: 'OSHA construction fall protection duty open edge',
    classification: 'Fall Protection',
    agencyMode: 'osha_construction',
    fusedText: 'Construction employee exposed to an unprotected open side more than 6 feet above lower level without guardrail, safety net, or personal fall arrest system.',
    expectedAny: [/1926\.501/i, /duty to have fall protection/i, /fall protection/i],
    rejectTop: [/1910\.140/i, /1910\.23/i, /stairways and ladders/i, /1926\.1050/i],
  },
  {
  ...
  {
    name: 'MSHA MNM surface electrical equipment lockout',
    classification: 'Lockout / Stored Energy',
    agencyMode: 'msha_mnm_surface',
    fusedText: 'Surface metal nonmetal mine electrically powered equipment was being mechanically repaired before it was deenergized and locked out.',
    expectedAny: [/56\.12016/i, /work on electrically-powered equipment/i],
    rejectTop: [/57\.12016/i, /75\.511/i, /77\./i, /1926\.417/i, /1910\.147/i],
  },
  {
    name: 'MSHA MNM underground electrical equipment lockout',
    classification: 'Lockout / Stored Energy',
    agencyMode: 'msha_mnm_underground',
    fusedText: 'Underground metal nonmetal mine electrically powered equipment was being mechanically repaired before it was deenergized and locked out.',
    expectedAny: [/57\.12016/i, /work on electrically-powered equipment/i],
    rejectTop: [/56\.12016/i, /75\.511/i, /77\./i, /1926\.417/i, /1910\.147/i],
  },
  {
  ...
  {
    name: 'MSHA coal underground machine guarding conveyor pulley',
    classification: 'Machine Guarding',
    agencyMode: 'msha_coal_underground',
    fusedText: 'Underground coal mine conveyor drive pulley and exposed moving machine parts were not guarded from contact.',
    expectedAny: [/75\.1722/i, /mechanical equipment guards/i, /moving machine parts/i],
    rejectTop: [/56\.14107/i, /57\.14107/i, /77\.400/i, /fall protection/i, /confined/i],
  },
  {
