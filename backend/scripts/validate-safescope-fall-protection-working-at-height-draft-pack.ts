...
const PACK_PATH = path.resolve(__dirname, '../../safescope-data/approved-knowledge/draft-candidates/fall-protection-working-at-height-draft-candidates.v1.json');
...
async function validate() {
  ...
  if (pack.packId !== "fall-protection-working-at-height-draft-candidates") {
  ...
  const keywords = ['fall protection', 'guardrail', 'ladder', 'scaffold', 'floor opening', 'working at height', 'falling object'];
