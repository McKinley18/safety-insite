 ...
 * `src/safescope-v2/expert-hazlenz/contract/expert-226-property-selection-capability.ts` and is re-exported here unchanged.
 *
 ...
 */
export * from '../../src/safescope-v2/expert-hazlenz/contract/expert-226-property-selection-capability';
