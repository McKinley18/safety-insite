 ...
 * `src/hazlenz/expert-hazlenz/contract/expert-226-property-selection-capability.ts` and is re-exported here unchanged.
 *
 ...
 */
export * from '../../src/hazlenz/expert-hazlenz/contract/expert-226-property-selection-capability';
