 ...
 * `src/safescope-v2/expert-hazlenz/contract/expert-first-pass-instruction-210b2.ts` and is re-exported here unchanged.
 *
 ...
 */
export * from '../../src/safescope-v2/expert-hazlenz/contract/expert-first-pass-instruction-210b2';
