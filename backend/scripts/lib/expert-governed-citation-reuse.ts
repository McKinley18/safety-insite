 ...
 * `src/safescope-v2/expert-hazlenz/contract/expert-governed-citation-reuse.ts` and is re-exported here unchanged.
 *
 ...
 */
export * from '../../src/safescope-v2/expert-hazlenz/contract/expert-governed-citation-reuse';
