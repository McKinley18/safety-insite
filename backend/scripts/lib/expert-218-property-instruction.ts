 ...
 * `src/safescope-v2/expert-hazlenz/contract/expert-218-property-instruction.ts` and is re-exported here unchanged.
 *
 ...
 */
export * from '../../src/safescope-v2/expert-hazlenz/contract/expert-218-property-instruction';
