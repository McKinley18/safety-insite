 ...
 * `src/safescope-v2/expert-hazlenz/contract/expert-212-challenge-vocabulary.ts` and is re-exported here unchanged.
 *
 ...
 */
export * from '../../src/safescope-v2/expert-hazlenz/contract/expert-212-challenge-vocabulary';
