...
import { ReviewerCandidateConsoleValidator } from '../src/hazlenz/reviewer-candidate-console/reviewer-candidate-console.validator';
...
async function validate() {
  ...
  console.log('✅ HazLenz reviewer candidate console validation passed.');
}
