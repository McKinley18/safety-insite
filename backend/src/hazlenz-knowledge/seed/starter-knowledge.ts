...
export const starterKnowledge: StarterKnowledgeDocument[] = [
  ...
  },
  {
    ...
    rawText:
      'Mobile equipment hazards are indicated when workers, pedestrians, spotters, mechanics, or light vehicles are exposed to haul trucks, loaders, forklifts, service trucks, or other powered mobile equipment. HazLenz should identify struck-by, caught-between, run-over, backing, dumping, berm, visibility, and blind-spot concerns. Critical evidence includes traffic pattern, pedestrian route, lighting, backup alarms, cameras, spotter location, radio communication, berm condition, grade, speed, and whether workers are in the line of fire. Recommended controls include separating pedestrians and equipment, establishing traffic control, using spotters safely, improving visibility, verifying alarms and cameras, maintaining berms, setting exclusion zones, and documenting corrective actions.',
  },
  {
    ...
    rawText:
      'Fall hazards are indicated when workers are exposed to unprotected edges, floor holes, wall openings, ladders, platforms, scaffolds, roofs, elevated maintenance points, unstable access, or missing guardrails. HazLenz should ask for height, surface condition, access method, guardrail or fall protection status, worker task, duration of exposure, and rescue considerations. Recommended controls include guardrails, covers, safe access, ladder correction, fall arrest or restraint systems, anchor verification, housekeeping at elevated surfaces, and closure evidence showing the corrected edge, cover, ladder, or protection system.',
  },
  {
  ...
  },
  {
    ...
    rawText:
      'Confined space hazards are indicated when workers enter or may enter tanks, vessels, silos, pits, vaults, manholes, hoppers, ducts, or similar spaces with limited entry or exit and not designed for continuous occupancy. HazLenz should ask whether atmospheric testing was performed, whether ventilation is needed, whether engulfment, mechanical, electrical, or chemical hazards exist, whether entry permit controls are required, whether an attendant is present, and whether rescue planning is adequate. Recommended controls include space evaluation, permit system where required, atmospheric testing, isolation, ventilation, attendant assignment, communication, rescue capability, and closure evidence such as permit verification or supervisor sign-off.',
  },
  {
    ...
    rawText:
      'Housekeeping hazards are indicated when aisles, walkways, stairs, platforms, exits, work areas, or travel paths are blocked, slippery, cluttered, uneven, poorly drained, or obstructed by materials, hoses, cords, debris, tools, pallets, or spilled substances. HazLenz should ask whether the path is a required travelway or emergency route, whether the condition creates slip or trip exposure, whether materials are stored securely, and whether immediate cleanup or barricading is needed. Recommended controls include cleaning spills, removing obstructions, securing cords and hoses, improving drainage, marking walkways, correcting storage, and documenting closure with before-and-after photos.',
  },
  {
