...
export class InitialMigration1777429229824 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        const hasStandardsMaster = await queryRunner.hasTable("standards_master");
        if (!hasStandardsMaster) {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX IF NOT EXISTS "IDX_c27d52393c2c29e8c67eb4192e" ON "standards_master" ("agency_code", "citation") `);
