...
const RAW_STANDARDS_INTELLIGENCE_SEED: StandardsIntelligenceRecord[] = [
  ...
  },
  {
    ...
    part: "1910",
    subpart: "N",
    title: "Powered industrial trucks - General requirements",
  ...
  },
  {
    ...
    plainLanguageSummary: "Walking-working surfaces must be kept in a clean, orderly, and sanitary condition to prevent slips, trips, and falls.",
    hazardFamilies: ["Slips, Trips, Falls", "Walking/Working Surfaces"],
    equipmentTags: ["walkway", "passageway", "floor", "surface"],
    taskTags: ["operation", "maintenance", "inspection"],
    exposureTags: ["slip exposure", "trip exposure"],
    controlTags: ["housekeeping", "maintenance", "surface condition"],
    consequenceTags: ["slip", "trip", "fall", "injury"],
    searchBoostTerms: ["slip", "trip", "housekeeping", "surface condition", "passageway", "wet", "floor", "water", "walkway", "flat", "cleaning", "spill", "tidy", "maintenance", "level", "surface", "walking", "same level"],
    authorityTier: 1,
    applicabilityBandDefault: "primary",
    severityDefault: "medium",
    evidenceRequirements: [
      { question: "Is the surface part of an employee walkway, passageway, or work area?", requiredForPrimary: true, missingEvidenceImpact: "high" },
      { question: "Is the surface condition clean, orderly, and free of slip/trip hazards?", requiredForPrimary: true, missingEvidenceImpact: "medium" }
    ],
    exclusionRules: [{ reason: "Elevated fall protection is required instead.", excludeWhenMissingAny: ["open edge", "platform", "hole", "ladder"] }],
  ...
  },
  {
    ...
    subpart: "D",
    title: "Ladders",
    plainLanguageSummary: "Portable and fixed ladders must be maintained, inspected, and properly used to prevent stability and fall hazards.",
    hazardFamilies: ["Ladders", "Fall Protection"],
    equipmentTags: ["ladder", "portable ladder", "fixed ladder"],
    taskTags: ["access", "maintenance", "inspection"],
    exposureTags: ["fall from height", "ladder instability"],
    controlTags: ["stabilization", "securing", "inspection"],
    consequenceTags: ["fall", "fatality", "fracture"],
    searchBoostTerms: ["ladder", "unstable ladder", "missing securement"],
    authorityTier: 1,
    applicabilityBandDefault: "primary",
    severityDefault: "high",
    evidenceRequirements: [
      { question: "Is the ladder type (portable or fixed) and its condition established?", requiredForPrimary: true, missingEvidenceImpact: "high" },
      { question: "Is the ladder stabilized, secured, or properly set up on a stable surface?", requiredForPrimary: true, missingEvidenceImpact: "high" }
    ],
    exclusionRules: [{ reason: "Not applicable to flat surface slip hazards.", excludeWhenMissingAny: ["ladder"] }],
  ...
  },
  {
    ...
    plainLanguageSummary: "Employers must provide fall protection for employees on surfaces 4 feet or more above lower levels.",
    hazardFamilies: ["Fall Protection", "Walking/Working Surfaces"],
    equipmentTags: ["platform", "open edge", "unprotected side", "hole", "floor opening"],
    taskTags: ["elevated work", "maintenance"],
    exposureTags: ["fall-to-lower-level", "unprotected edge"],
    controlTags: ["guardrail", "fall arrest", "cover"],
    consequenceTags: ["fall", "fatality", "fracture"],
    searchBoostTerms: ["open edge", "platform", "unprotected side", "fall protection", "hole"],
    authorityTier: 1,
    applicabilityBandDefault: "primary",
    severityDefault: "critical",
    evidenceRequirements: [
      { question: "Is the employee working on a surface 4 feet or more above a lower level?", requiredForPrimary: true, missingEvidenceImpact: "high" },
      { question: "Is there an open side, edge, or floor hole without fall protection?", requiredForPrimary: true, missingEvidenceImpact: "high" }
    ],
    exclusionRules: [{ reason: "Flat surface slip hazard.", excludeWhenMissingAny: ["elevated", "open edge", "platform", "hole", "fall"] }],
    crossDomainLinks: ["Scaffolds", "Ladders"]
  },
  {
    citation: "29 CFR 1926.501",
    agency: "OSHA",
    ...
    subpart: "M",
    title: "Duty to have fall protection",
    plainLanguageSummary: "Construction employers must provide fall protection where employees are exposed to fall hazards 6 feet or more above lower levels.",
    hazardFamilies: ["Fall Protection", "Walking/Working Surfaces"],
    equipmentTags: ["leading edge", "open side", "floor hole", "scaffold", "roof"],
    taskTags: ["construction", "roofing", "elevated work"],
    exposureTags: ["fall-to-lower-level", "unprotected edge"],
    controlTags: ["guardrail", "safety net", "fall arrest"],
    consequenceTags: ["fall", "fatality", "fracture"],
    searchBoostTerms: ["construction", "leading edge", "fall protection", "six feet"],
    authorityTier: 1,
    applicabilityBandDefault: "primary",
    severityDefault: "critical",
    evidenceRequirements: [
      { question: "Is this construction work?", requiredForPrimary: true, missingEvidenceImpact: "high" },
      { question: "Is the fall exposure 6 feet or more above a lower level?", requiredForPrimary: true, missingEvidenceImpact: "high" },
      { question: "Is fall protection present (guardrail, net, personal arrest)?", requiredForPrimary: false, missingEvidenceImpact: "high" }
    ],
    exclusionRules: [{ reason: "Flat surface slip hazard.", excludeWhenMissingAny: ["elevated", "leading edge", "open edge", "hole", "fall"] }],
    crossDomainLinks: ["Scaffolds", "Ladders"]
  },
  {
    ...
    plainLanguageSummary: "Safety belts and lines must be worn when miners work where there is danger of falling.",
    hazardFamilies: ["Fall Protection"],
    equipmentTags: ["bins", "tanks", "elevated deck", "platform", "edge"],
    taskTags: ["elevated work", "maintenance"],
    exposureTags: ["danger of falling", "elevated work"],
    controlTags: ["safety belt", "lifeline", "fall protection"],
    consequenceTags: ["fall", "fatality"],
    searchBoostTerms: ["safety belt", "lifeline", "fall danger", "elevated"],
    authorityTier: 1,
    applicabilityBandDefault: "primary",
    severityDefault: "critical",
    evidenceRequirements: [
      { question: "Is there a danger of falling from elevation?", requiredForPrimary: true, missingEvidenceImpact: "high" },
      { question: "Are safety belts or lifelines used or tended?", requiredForPrimary: false, missingEvidenceImpact: "high" }
    ],
    exclusionRules: [],
    crossDomainLinks: ["Workplace Examination", "Ground Control"]
  },
  {
    ...
    subpart: "J",
    title: "Safe access",
    plainLanguageSummary: "Safe means of access must be provided and maintained to all working places.",
    hazardFamilies: ["Walking/Working Surfaces", "Access"],
    equipmentTags: ["ladder", "stairway", "walkway", "platform", "screen deck"],
    taskTags: ["access", "travelway", "maintenance"],
    exposureTags: ["restricted access", "unsafe access"],
    controlTags: ["handrail", "stairway", "ladder condition"],
    consequenceTags: ["slip", "trip", "fall", "injury"],
    searchBoostTerms: ["safe access", "travelway", "access to working place"],
    authorityTier: 1,
    applicabilityBandDefault: "primary",
    severityDefault: "medium",
    evidenceRequirements: [
      { question: "Is the access point to a working place?", requiredForPrimary: true, missingEvidenceImpact: "high" },
      { question: "Are stairs, ladders, or walkways maintained and safe?", requiredForPrimary: true, missingEvidenceImpact: "medium" }
    ],
    exclusionRules: [],
    crossDomainLinks: ["Fall Protection"]
  },
  {
    citation: "29 CFR 1910.29",
    agency: "OSHA",
    scope: "osha-general-industry",
    part: "1910",
    subpart: "D",
    title: "Fall protection systems and falling object protection criteria",
    plainLanguageSummary: "Criteria for guardrail systems, cover systems, and personal fall protection system components.",
    hazardFamilies: ["Fall Protection"],
    equipmentTags: ["guardrail", "fall arrest", "cover"],
    taskTags: ["maintenance"],
    exposureTags: ["unprotected edge"],
    controlTags: ["guardrail", "fall arrest system"],
    consequenceTags: ["fall"],
    searchBoostTerms: ["guardrail criteria", "fall protection systems"],
    authorityTier: 1,
    applicabilityBandDefault: "supporting",
    severityDefault: "high",
    evidenceRequirements: [
        { question: "Is the guardrail, cover, or fall arrest system being evaluated for adequacy?", requiredForPrimary: true, missingEvidenceImpact: "medium" }
    ],
    exclusionRules: [],
    crossDomainLinks: ["Fall Protection"]
  },
  {
    ...
    plainLanguageSummary: "Criteria for construction guardrail, safety net, and personal fall arrest system components.",
    hazardFamilies: ["Fall Protection"],
    equipmentTags: ["guardrail", "safety net", "fall arrest"],
    taskTags: ["construction"],
    exposureTags: ["unprotected edge"],
    controlTags: ["guardrail", "safety net", "fall arrest system"],
    consequenceTags: ["fall"],
    searchBoostTerms: ["construction guardrail criteria", "fall protection systems criteria"],
    authorityTier: 1,
    applicabilityBandDefault: "supporting",
    severityDefault: "high",
    evidenceRequirements: [
        { question: "Is the construction fall protection system being evaluated for adequacy?", requiredForPrimary: true, missingEvidenceImpact: "medium" }
    ],
    exclusionRules: [],
    crossDomainLinks: ["Fall Protection"]
  },
