...
pass('needs-more-evidence remains family coherent', needs.output.needsMoreEvidenceStandards.every((standard) => /1910\.33|1910\.30|1910\.305|1910\.303|electrical/i.test(`${standard.citation} ${standard.title || ''}`)) && !needs.output.needsMoreEvidenceStandards.some((standard) => /1910\.1200|1910\.184|1910\.218|1910\.177|1910\.178|1910\.179|crane|slings|forging|rim wheel/i.test(`${standard.citation} ${standard.title || ''}`)), needs.output.needsMoreEvidenceStandards);
