...
function decision(
  ...
  return {
    ...
    confidence: status === 'SUPPORTED' || status === 'NOT_APPLICABLE' ? 0.96 : status === 'UNKNOWN' ? 0.45 : 0.05,
...
function evaluate(e: Extracted): ApplicabilityDecision[] {
  ...
  if (mine && servicing) output.push(decision(e, '30 CFR 56.12016', 'MSHA energy control', [
    ['MSHA jurisdiction', mine, ids(e, 'jurisdiction')],
    ['electrical or mechanical servicing activity', servicing, ids(e, 'workActivity')],
    ['hazardous energy present or capable', activeEnergy, ids(e, 'energyState')],
  ...
  if (mine && has(e, 'groundCondition')) output.push(decision(e, '30 CFR 56.3200', 'MSHA ground control', [
    ['MSHA jurisdiction', mine, ids(e, 'jurisdiction')],
  ...
  if (mine && has(e, 'electricalLiveParts')) output.push(decision(e, '30 CFR 56.12025', 'MSHA electrical grounding and continuity', [
    ['MSHA jurisdiction', mine, ids(e, 'jurisdiction')],
    ['exposed or damaged conductor', true, ids(e, 'electricalLiveParts')],
    ['energized or capable', activeEnergy, ids(e, 'energyState')],
    ['conductive contact pathway', has(e, 'environment', 'wet_or_conductive') || /\bholds?|touch(?:ing|es)?\b/i.test(e.text),
      [...ids(e, 'environment'), ...ids(e, 'employeeExposure')]],
  ]));
  if (mine && has(e, 'guardState')) {
  ...
  if (mine && has(e, 'backupAlarmState')) {
  ...
  if (mine && has(e, 'fallExposure')) output.push(decision(e, '30 CFR 56.15005', 'MSHA fall protection', [
    ['MSHA jurisdiction', mine, ids(e, 'jurisdiction')],
  ...
  if (gi && has(e, 'guardState')) {
    ...
    output.push(decision(e, '29 CFR 1910.212(a)(1)', 'OSHA General Industry machine guarding', [
      ['general-industry jurisdiction', gi, ids(e, 'jurisdiction')],
  ...
  if (gi && has(e, 'electricalLiveParts')) output.push(decision(e, '29 CFR 1910.303', 'OSHA General Industry live electrical parts', [
    ['general-industry jurisdiction', gi, ids(e, 'jurisdiction')],
  ...
  if (gi && servicing) output.push(decision(e, '29 CFR 1910.147', 'OSHA General Industry hazardous energy control', [
    ['general-industry jurisdiction', gi, ids(e, 'jurisdiction')],
    ['servicing or maintenance activity', true, ids(e, 'workActivity')],
    ['hazardous energy present or capable', activeEnergy ? true :
      has(e, 'energyState', 'deenergized') ? false : undefined, ids(e, 'energyState')],
    ['energy not isolated and locked', notIsolated ? true :
      has(e, 'energyIsolationState', 'isolated_and_verified') ? false : undefined, ids(e, 'energyIsolationState')],
  ]));
  if (gi && has(e, 'egressRoute')) output.push(decision(e, '29 CFR 1910.36', 'OSHA exit routes', [
    ['general-industry jurisdiction', gi, ids(e, 'jurisdiction')],
    ['occupied workplace', /\b(occupied|shift|employees?|workers?)\b/i.test(e.text), ids(e, 'employeeExposure')],
  ...
  if (gi && has(e, 'chemicalLabelState')) {
  ...
  if (gi && has(e, 'fallExposure')) output.push(decision(e, '29 CFR 1910.28', 'OSHA walking-working surface fall protection', [
    ['general-industry jurisdiction', gi, ids(e, 'jurisdiction')],
  ...
  if (construction && has(e, 'workAreaType', 'excavation')) {
    ...
    output.push(decision(e, '29 CFR 1926.652(a)(1)', 'OSHA Construction excavation protective systems', [
      ['construction jurisdiction', construction, ids(e, 'jurisdiction')],
  ...
  if (construction && has(e, 'loadState', 'suspended')) output.push(decision(e, '29 CFR 1926.1425', 'OSHA Construction crane fall zone', [
    ['construction jurisdiction', construction, ids(e, 'jurisdiction')],
  ...
  if (construction && has(e, 'equipmentType', 'crane') && has(e, 'electricalLine')) output.push(decision(
  ...
  if (construction && has(e, 'workAreaType', 'scaffold')) {
  ...
  if (construction && has(e, 'silicaGeneratingTask')) output.push(decision(
  ...
  if (construction && has(e, 'fallExposure')) output.push(decision(e, '29 CFR 1926.501', 'OSHA Construction fall protection', [
    ['construction jurisdiction', construction, ids(e, 'jurisdiction')],
  ...
  if (gi && e.noiseTwa !== undefined) output.push(decision(e, '29 CFR 1910.95', 'OSHA occupational noise', [
    ['general-industry jurisdiction', gi, ids(e, 'jurisdiction')],
...
export function applyEvidenceFoundation(result: any, request: ClassifyDto) {
  ...
  const prioritized = unknown.flatMap(item => item.missingPredicates.map(missing => ({
