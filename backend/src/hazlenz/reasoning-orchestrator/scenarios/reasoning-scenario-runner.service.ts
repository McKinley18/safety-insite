import { HazLenzReasoningOrchestratorService } from '../reasoning-orchestrator.service';
import {
  HazLenzReasoningScenario,
  HazLenzReasoningScenarioResult,
  HazLenzReasoningScenarioSuiteResult,
} from './reasoning-scenario.types';

export class HazLenzReasoningScenarioRunnerService {
  constructor(private readonly orchestrator = new HazLenzReasoningOrchestratorService()) {}

  run(scenarios: HazLenzReasoningScenario[]): HazLenzReasoningScenarioSuiteResult {
  ...
  private runScenario(scenario: HazLenzReasoningScenario): HazLenzReasoningScenarioResult {
