import { HazLenzEquipmentArchetypeRegistry } from './equipment-archetype.types';
...
export const HAZLENZ_EQUIPMENT_ARCHETYPE_REGISTRY: HazLenzEquipmentArchetypeRegistry = {
