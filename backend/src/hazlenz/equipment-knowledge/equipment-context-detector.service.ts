import { HAZLENZ_EQUIPMENT_KNOWLEDGE_REGISTRY } from './equipment-knowledge.registry';
import { HazLenzEquipmentKnowledgeRecord } from './equipment-knowledge.types';

export type HazLenzDetectedEquipmentContext = {
...
export type HazLenzEquipmentContextRequest = {
...
export class HazLenzEquipmentContextDetectorService {
  detect(request: HazLenzEquipmentContextRequest): HazLenzDetectedEquipmentContext {
    const text = [
    ...
    const detectedEquipment = HAZLENZ_EQUIPMENT_KNOWLEDGE_REGISTRY.records
  ...
  private scoreRecord(record: HazLenzEquipmentKnowledgeRecord, text: string): HazLenzDetectedEquipmentContext['detectedEquipment'][number] {
