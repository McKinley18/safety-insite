import { HazLenzEquipmentTaskMechanismRecord } from './equipment-task-mechanism.types';

export const HAZLENZ_EQUIPMENT_TASK_MECHANISM_REGISTRY: HazLenzEquipmentTaskMechanismRecord[] = [
  {
