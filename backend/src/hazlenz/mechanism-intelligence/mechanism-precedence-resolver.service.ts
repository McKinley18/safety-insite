import {
  HazLenzMechanismPrecedenceInput,
  HazLenzMechanismPrecedenceResult,
...
export class HazLenzMechanismPrecedenceResolverService {
  resolve(input: HazLenzMechanismPrecedenceInput): HazLenzMechanismPrecedenceResult {
