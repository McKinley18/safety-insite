import {
  ...
  HazLenzEnergySource,
  HazLenzInjuryMechanism,
} from "./mechanism-intelligence.types";

type MechanismDomain = {
  keys: string[];
  energySources: HazLenzEnergySource[];
  injuryMechanisms: HazLenzInjuryMechanism[];
...
export class HazLenzMechanismIntelligenceService {
  evaluate(input: MechanismIntelligenceInput): MechanismIntelligenceOutput {
    ...
    return {
      ...
      sourceBoundary:
        "HazLenz mechanism intelligence explains credible injury pathways, energy transfer, exposure mechanisms, and verification needs. It cannot invent citations, override OSHA/MSHA requirements, reduce required human review, or finalize compliance decisions.",
    };
  }
}
