import {
  HazLenzControlEffectivenessInput,
  HazLenzControlEffectivenessOutput,
  HazLenzControlEffectivenessRating,
...
export class HazLenzControlEffectivenessService {
  evaluate(input: HazLenzControlEffectivenessInput): HazLenzControlEffectivenessOutput {
    ...
    return {
      ...
      sourceBoundary:
        'HazLenz control effectiveness intelligence evaluates whether controls plausibly interrupt the hazard, energy, exposure, and recurrence pathways. It cannot assume effectiveness, bypass verification, reduce qualified review, or finalize closure without evidence.',
    };
  }
