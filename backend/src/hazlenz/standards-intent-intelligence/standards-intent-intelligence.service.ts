...
import {
  HazLenzStandardsIntentConfidence,
  HazLenzStandardsIntentInput,
  HazLenzStandardsIntentOutput,
  HazLenzStandardIntentProfile,
...
export class HazLenzStandardsIntentIntelligenceService {
  evaluate(input: HazLenzStandardsIntentInput): HazLenzStandardsIntentOutput {
    ...
    const standardsCoverageGaps = unique([
      !standards.length ? 'No standard candidate was supplied; HazLenz cannot infer final regulatory applicability.' : '',
  ...
  private machineGuardingProfile(citation: string, standardTitle: string, agencyOrAuthority: string, input: any): HazLenzStandardIntentProfile {
    return {
      citation,
      standardTitle,
      agencyOrAuthority,
  ...
  private lockoutProfile(citation: string, standardTitle: string, agencyOrAuthority: string, input: any): HazLenzStandardIntentProfile {
    return {
      citation,
      standardTitle,
      agencyOrAuthority,
  ...
  private electricalProfile(citation: string, standardTitle: string, agencyOrAuthority: string, input: any): HazLenzStandardIntentProfile {
    return {
      citation,
      standardTitle,
      agencyOrAuthority,
  ...
  private fallProtectionProfile(citation: string, standardTitle: string, agencyOrAuthority: string, input: any): HazLenzStandardIntentProfile {
    return {
      citation,
      standardTitle,
      agencyOrAuthority,
  ...
  private confinedSpaceProfile(citation: string, standardTitle: string, agencyOrAuthority: string, input: any): HazLenzStandardIntentProfile {
    return {
      citation,
      standardTitle,
      agencyOrAuthority,
  ...
  private hazcomProfile(citation: string, standardTitle: string, agencyOrAuthority: string, input: any): HazLenzStandardIntentProfile {
    return {
      citation,
      standardTitle,
      agencyOrAuthority,
  ...
  private industrialHygieneProfile(citation: string, standardTitle: string, agencyOrAuthority: string, input: any): HazLenzStandardIntentProfile {
    return {
      citation,
      standardTitle,
      agencyOrAuthority,
  ...
  private mobileEquipmentProfile(citation: string, standardTitle: string, agencyOrAuthority: string, input: any): HazLenzStandardIntentProfile {
    return {
      citation,
      standardTitle,
      agencyOrAuthority,
  ...
  private cranesRiggingHoistingProfile(citation: string, standardTitle: string, agencyOrAuthority: string, input: any): HazLenzStandardIntentProfile {
    return {
      citation,
      standardTitle,
      agencyOrAuthority,
  ...
  private bloodbornePathogensProfile(citation: string, standardTitle: string, agencyOrAuthority: string, input: any): HazLenzStandardIntentProfile {
    return {
      citation,
      standardTitle,
      agencyOrAuthority,
  ...
  private ergonomicsProfile(citation: string, standardTitle: string, agencyOrAuthority: string, input: any): HazLenzStandardIntentProfile {
    return {
      citation,
      standardTitle,
      agencyOrAuthority,
  ...
  private trenchingExcavationProfile(citation: string, standardTitle: string, agencyOrAuthority: string, input: any): HazLenzStandardIntentProfile {
    return {
      citation,
      standardTitle,
      agencyOrAuthority,
  ...
  private genericProfile(citation: string, standardTitle: string, agencyOrAuthority: string, input: any): HazLenzStandardIntentProfile {
  ...
  private profileConfidence(input: any, minimumSignals: number): HazLenzStandardsIntentConfidence {
    const matrix = input.matrix || {};
