export type HazLenzStandardsIntentConfidence = 'low' | 'medium' | 'high';

export type HazLenzStandardIntentProfile = {
  citation: string;
  ...
  confidence: HazLenzStandardsIntentConfidence;
};

export type HazLenzStandardsIntentInput = {
...
export type HazLenzStandardsIntentOutput = {
  engine: 'safescope_standards_intent_intelligence';
  mode: 'deterministic_offline';
  classification: string;
  standardIntentProfiles: HazLenzStandardIntentProfile[];
