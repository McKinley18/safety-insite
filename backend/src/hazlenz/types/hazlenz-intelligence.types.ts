export type HazLenzRiskProfileId =
  | "simple_4x4"
  | "standard_5x5"
  | "advanced_6x6";

export type HazLenzPriorFinding = {
  id?: string | number;
...
export type HazLenzIntelligenceContext = {
  fusedText: string;
  promotedPrimary: any;
  ...
  priorFindings?: HazLenzPriorFinding[];
};
...
import { HazLenzNormalizedObservationContext } from '../brain/observation-context/observation-context.types';
import { HazLenzNarrative } from '../brain/narrative-generator/narrative.types';
...
export type HazLenzIntelligenceResult = {
  observationContext?: HazLenzNormalizedObservationContext;
  narrative?: HazLenzNarrative;
