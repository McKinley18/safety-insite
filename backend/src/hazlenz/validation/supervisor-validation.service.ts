...
import { HazLenzSupervisorValidation } from './supervisor-validation.entity';
...
export class SupervisorValidationService {
  constructor(
    @InjectRepository(HazLenzSupervisorValidation)
    private readonly validationRepo: Repository<HazLenzSupervisorValidation>,
