...
import {
  HazLenzCausalChainInput,
  HazLenzCausalChainOutput,
  HazLenzCausalChainConfidence,
...
export class HazLenzCausalChainService {
  evaluate(input: HazLenzCausalChainInput): HazLenzCausalChainOutput {
    ...
    return {
      ...
      sourceBoundary:
        'HazLenz causal chain intelligence explains plausible hazard-to-injury pathways using available evidence, mechanism intelligence, exposure intelligence, evidence sufficiency, and action quality signals. It cannot invent causation, determine root cause without evidence, override OSHA/MSHA requirements, or reduce required qualified human review.',
    };
  }
