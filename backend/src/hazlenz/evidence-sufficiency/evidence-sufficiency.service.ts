...
import {
  ...
  HazLenzEvidenceConfidenceImpact,
...
@Injectable()
export class HazLenzEvidenceSufficiencyService {
  evaluate(input: EvidenceSufficiencyInput): EvidenceSufficiencyOutput {
    ...
    return {
      ...
      sourceBoundary:
        'HazLenz evidence sufficiency intelligence evaluates whether available field evidence supports hazard recognition, standards recommendation, corrective action, and closure. It cannot invent evidence, replace measurements, reduce required review, or finalize compliance decisions without adequate support.',
    };
  }
