import {
  ...
  KnowledgeQueueActor,
  KnowledgeQueueGuardDecision,
} from './knowledge-review-queue.api-types';

const MUTATING_ACTIONS: KnowledgeQueueActionType[] = [
  'create_draft',
  'approve',
  'reject',
  'request_more_info',
...
const APPROVAL_ACTIONS: KnowledgeQueueActionType[] = ['approve', 'supersede'];

export class KnowledgeReviewQueueGuard {
  canPerform(
