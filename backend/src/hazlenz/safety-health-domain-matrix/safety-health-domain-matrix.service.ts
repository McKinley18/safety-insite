import {
  HazLenzDomainMatrixDomain,
  HazLenzSafetyHealthDomainMatrixInput,
  HazLenzSafetyHealthDomainMatrixOutput,
  HazLenzDomainMatrixConfidence,
...
const DOMAIN_MATRIX: HazLenzDomainMatrixDomain[] = [
  {
  ...
  },
  {
    ...
    regulatoryCautionNotes: ['HazLenz must distinguish maintenance/service exposure from normal operation and cannot assume LOTO adequacy without verification.'],
  },
  {
    domain: 'Electrical',
  ...
  },
  {
    ...
    regulatoryCautionNotes: ['Noise compliance requires exposure assessment; HazLenz cannot infer dose from qualitative description alone.'],
  },
  {
    domain: 'Heat Stress',
...
export class HazLenzSafetyHealthDomainMatrixService {
  evaluate(input: HazLenzSafetyHealthDomainMatrixInput): HazLenzSafetyHealthDomainMatrixOutput {
  ...
  private unclassifiedDomain(): HazLenzDomainMatrixDomain {
    return {
      domain: 'Unclassified',
      aliases: [],
