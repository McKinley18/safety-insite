...
// protected hazlenz.service.ts's own resultStage/mayFinalize decision -- it can only turn
...
/**
 * Applied as a controller-level post-process (see hazlenz.controller.ts), the same pattern
