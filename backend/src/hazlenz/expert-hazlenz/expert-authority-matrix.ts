...
export const EXPERT_AUTHORITY_SURFACES: readonly ExpertAuthoritySurface[] = [
  {
    ...
    authoritySource: 'src/hazlenz/engine/deterministic-classifier.ts',
  ...
  },
  {
    ...
    authoritySource: 'src/hazlenz/multi-hazard-decomposition/multi-hazard-decomposition.service.ts',
  ...
  },
  {
    ...
    authoritySource: 'src/hazlenz/tests/hazlenz-actionable-coverage-scorer.ts (scored floor)',
  ...
  },
  {
    ...
    authoritySource: 'src/hazlenz/inspection-intelligence/inspection-condition-assessment.service.ts',
    evidencePin: 'npx ts-node src/hazlenz/tests/hazlenz-condition-state-invariants-regression.ts',
    frozenContracts: ['DETERMINISTIC_LEVEL1_RECOGNITION_ACTIONABILITY_FLOOR'],
    permitted: ['CHALLENGE'],
    onDisagreement: 'RECORD_DISAGREEMENT_AND_RECOMMEND_REVIEW',
    onExpertUnavailable: 'SURFACE_UNCHANGED',
  ...
  },
  {
    ...
    authoritySource: 'src/hazlenz/reasoning-orchestrator/negation-context.util.ts',
    evidencePin: 'npx ts-node src/hazlenz/tests/hazlenz-energy-isolation-negation-regression.ts',
    frozenContracts: ['DETERMINISTIC_LEVEL1_RECOGNITION_ACTIONABILITY_FLOOR'],
    permitted: ['CHALLENGE'],
    onDisagreement: 'RECORD_DISAGREEMENT_ONLY',
    onExpertUnavailable: 'SURFACE_UNCHANGED',
  ...
  },
  {
    ...
    authoritySource: 'src/hazlenz/tests/hazlenz-actionable-coverage-scorer.ts',
  ...
  },
  {
    ...
    authoritySource: 'src/hazlenz/risk/',
  ...
  },
  {
    ...
    authoritySource: 'src/hazlenz/hazlenz.controller.ts applyInspectionRegulatoryContext',
  ...
  },
  {
    ...
    authoritySource: 'src/hazlenz/corrective-actions/',
