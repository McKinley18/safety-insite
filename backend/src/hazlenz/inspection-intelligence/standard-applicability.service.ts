...
import { HazLenzJurisdiction } from '../reasoning-orchestrator/reasoning-orchestrator.types';
...
export class StandardApplicabilityService {
  ...
  evaluate(text: string, jurisdiction: HazLenzJurisdiction): StandardApplicabilityResult {
