...
/**
 * KG-5B (Phase 2) -- the curated HazLenz standards, extracted from
 * `hazlenz-standards.seed.ts` so they can be read as DATA without executing a seed.
 *
...
export const HAZLENZ_CURATED_STANDARDS: Partial<Standard>[] = [
  {
    agencyCode: 'MSHA',
