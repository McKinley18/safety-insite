import { HazLenzReasoningDomain, HazLenzJurisdiction } from '../reasoning-orchestrator/reasoning-orchestrator.types';
...
export const STANDARDS_APPLICABILITY_REGISTRY: StandardsApplicabilityEntry[] = [
  ...
  {
    jurisdiction: 'osha_general_industry',
    domain: 'hazcom' as HazLenzReasoningDomain,
  ...
  {
    jurisdiction: 'osha_general_industry',
    domain: 'health_exposure' as HazLenzReasoningDomain,
  ...
  {
    jurisdiction: 'osha_general_industry',
    domain: 'bloodborne_pathogens' as HazLenzReasoningDomain,
    primaryCitation: '29 CFR 1910.1030',
    acceptableCitations: ['29 CFR 1910.1030'],
    rationale: 'Bloodborne pathogen exposure control requirements for sharps or bodily-fluid exposure.'
  },
  {
    jurisdiction: 'osha_general_industry',
    domain: 'industrial_hygiene' as HazLenzReasoningDomain,
  ...
  {
    jurisdiction: 'osha_general_industry',
    domain: 'ergonomics' as HazLenzReasoningDomain,
  ...
  {
    jurisdiction: 'osha_construction',
    domain: 'struck_by' as HazLenzReasoningDomain,
