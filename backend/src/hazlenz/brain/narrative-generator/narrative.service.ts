import { HazLenzNarrative, NarrativeMode } from './narrative.types';
import { HazLenzIntelligenceResult } from '../../types/hazlenz-intelligence.types';

export class NarrativeGeneratorService {
  generate(result: HazLenzIntelligenceResult, mode: NarrativeMode): HazLenzNarrative {
