import {
  HazLenzScenarioDisambiguationInput,
  HazLenzScenarioDisambiguationMatch,
  HazLenzScenarioDisambiguationRecord,
  HazLenzScenarioDisambiguationResult,
} from './scenario-disambiguation.types';
import { HAZLENZ_SCENARIO_DISAMBIGUATION_REGISTRY } from './scenario-disambiguation.registry';
...
export class HazLenzScenarioDisambiguationService {
  query(input: HazLenzScenarioDisambiguationInput): HazLenzScenarioDisambiguationResult {
    ...
    const matches: HazLenzScenarioDisambiguationMatch[] = HAZLENZ_SCENARIO_DISAMBIGUATION_REGISTRY
      .map((record: HazLenzScenarioDisambiguationRecord) => {
      ...
      .filter((match: HazLenzScenarioDisambiguationMatch) => match.score > 0)
      .sort((a: HazLenzScenarioDisambiguationMatch, b: HazLenzScenarioDisambiguationMatch) => b.score - a.score)
      .slice(0, limit);
  ...
  list() {
    return [...HAZLENZ_SCENARIO_DISAMBIGUATION_REGISTRY];
  }
}
