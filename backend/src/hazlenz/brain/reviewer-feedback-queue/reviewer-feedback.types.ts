import { HazLenzNormalizedObservationContext } from '../observation-context/observation-context.types';
...
export type ReviewerFeedbackRecord = {
  ...
  normalizedContextSnapshot: HazLenzNormalizedObservationContext;
