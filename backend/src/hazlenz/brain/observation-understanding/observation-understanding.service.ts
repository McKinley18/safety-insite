import {
  HazLenzObservationCondition,
  HazLenzObservationEntityKind,
  HazLenzObservationUnderstandingFinding,
...
function conditionSignals(text: string): HazLenzObservationCondition[] {
  const conditions: HazLenzObservationCondition[] = [];
...
export class HazLenzObservationUnderstandingService {
  analyze(textInput: string): HazLenzObservationUnderstandingResult {
    const text = normalize(textInput);
    const findings: HazLenzObservationUnderstandingFinding[] = [];
