...
import { HazLenzRegulatoryBrainService } from '../regulatory-brain/regulatory-brain.service';
import { HazLenzMechanismBrainService } from '../mechanism-brain/mechanism-brain.service';
import { HazLenzControlsBrainService } from '../controls-brain/controls-brain.service';
import { HazLenzEvidenceBrainService } from '../evidence-brain/evidence-brain.service';
import { HazLenzScenarioDisambiguationService } from '../scenario-disambiguation/scenario-disambiguation.service';
import { HazLenzEvidenceGapIntelligenceService } from '../evidence-gap-intelligence/evidence-gap-intelligence.service';
import { HazLenzDecisionConfidenceService } from '../decision-confidence/decision-confidence.service';
import { HazLenzLearningMemoryService } from '../learning-memory/learning-memory.service';
import { HazLenzImprovementCandidateEngineService } from '../improvement-candidate-engine/improvement-candidate-engine.service';
import { HazLenzObservationUnderstandingService } from '../observation-understanding/observation-understanding.service';
import { hasAnyNonNegatedTerm } from '../../reasoning-orchestrator/negation-context.util';
import {
  HazLenzBrainCompartmentSummary,
  HazLenzBrainQueryOrchestratorInput,
  HazLenzBrainSituationalAwarenessPacket,
...
export class HazLenzBrainQueryOrchestratorService {
  constructor(
    private readonly regulatoryBrain = new HazLenzRegulatoryBrainService(),
    private readonly mechanismBrain = new HazLenzMechanismBrainService(),
    private readonly controlsBrain = new HazLenzControlsBrainService(),
    private readonly evidenceBrain = new HazLenzEvidenceBrainService(),
    private readonly scenarioDisambiguation = new HazLenzScenarioDisambiguationService(),
    private readonly evidenceGapIntelligence = new HazLenzEvidenceGapIntelligenceService(),
    private readonly decisionConfidence = new HazLenzDecisionConfidenceService(),
    private readonly learningMemory = new HazLenzLearningMemoryService(),
    private readonly improvementCandidateEngine = new HazLenzImprovementCandidateEngineService(),
    private readonly observationUnderstanding = new HazLenzObservationUnderstandingService(),
  ) {}

  query(input: HazLenzBrainQueryOrchestratorInput): HazLenzBrainSituationalAwarenessPacket {
    ...
    const compartmentSummaries: HazLenzBrainCompartmentSummary[] = [
      {
    ...
    const reasoningNotes = [
      'HazLenz Brain Query Orchestrator is read-only.',
      ...
      'Production HazLenz reasoning is not modified by this service.',
    ];
