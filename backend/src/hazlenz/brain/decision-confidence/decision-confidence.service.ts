import {
  HazLenzDecisionConfidenceInput,
  HazLenzDecisionConfidenceResult,
  HazLenzDecisionDisposition,
  HazLenzDecisionConfidenceLevel,
...
export class HazLenzDecisionConfidenceService {
  assess(input: HazLenzDecisionConfidenceInput): HazLenzDecisionConfidenceResult {
    let score = 50;
    ...
    let recommendedDisposition: HazLenzDecisionDisposition =
  ...
  private resolveConfidenceLevel(
    score: number,
    disposition: HazLenzDecisionDisposition,
  ): HazLenzDecisionConfidenceLevel {
