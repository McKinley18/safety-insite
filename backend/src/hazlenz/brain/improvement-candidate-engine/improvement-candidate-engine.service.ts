import {
  HazLenzImprovementCandidate,
  HazLenzImprovementCandidateInput,
  HazLenzImprovementCandidateResult,
  HazLenzImprovementCandidateType,
  HazLenzImprovementCandidateUrgency,
...
function urgencyFor(supportCount: number, signals: HazLenzLearningSignalType[]): HazLenzImprovementCandidateUrgency {
...
function candidateTypeForSignal(signal: HazLenzLearningSignalType): HazLenzImprovementCandidateType | undefined {
...
function targetKeyFor(record: HazLenzLearningMemoryRecord, signal: HazLenzLearningSignalType): string | undefined {
...
function buildTitle(type: HazLenzImprovementCandidateType, targetKey: string): string {
...
export class HazLenzImprovementCandidateEngineService {
  generate(input: HazLenzImprovementCandidateInput): HazLenzImprovementCandidateResult {
    ...
    const grouped = new Map<string, HazLenzLearningMemoryRecord[]>();
    ...
    const candidates: HazLenzImprovementCandidate[] = [];
    ...
    for (const [groupKey, memories] of grouped.entries()) {
      ...
      const type = typeRaw as HazLenzImprovementCandidateType;
      const signalTypes = uniqueStrings(memories.flatMap((memory) => memory.signalTypes)) as HazLenzLearningSignalType[];
