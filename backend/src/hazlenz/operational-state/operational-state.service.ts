    ...
    return {
      ...
      stateAwarenessSummary:
        primaryState === "unknown"
          ? "Operational state is unclear. HazLenz needs more context about whether work was active, maintenance, cleaning, startup, shutdown, or emergency response."
          : `HazLenz inferred operational state as ${primaryState.replaceAll("_", " ")} based on narrative and energy-state signals.`,
    };
  }
}
