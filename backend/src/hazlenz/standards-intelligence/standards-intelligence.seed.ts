...
const RAW_STANDARDS_INTELLIGENCE_SEED: StandardsIntelligenceRecord[] = [
  ...
  },
  {
    ...
    // (hazlenz-standards.seed.ts), which carries no source fields at all, so finalization
  ...
  // before them, they exist ONLY in the starter seed (hazlenz-standards.seed.ts), which carries
