...
export class RealImageAnalysisService {
  private readonly advisoryBoundary = "HazLenz real image analysis is advisory only and based on metadata, captions, and simulated vision findings. It does not make regulatory determinations.";
