import {
  HazLenzHazardDomainConfidence,
  HazLenzHazardDomainIntelligenceInput,
  HazLenzHazardDomainIntelligenceOutput,
  HazLenzHazardDomainProfile,
...
const DOMAIN_PROFILES: HazLenzHazardDomainProfile[] = [
  {
...
export class HazLenzHazardDomainIntelligenceService {
  evaluate(input: HazLenzHazardDomainIntelligenceInput): HazLenzHazardDomainIntelligenceOutput {
  ...
  private getFallbackProfile(classification: string): HazLenzHazardDomainProfile {
    return {
