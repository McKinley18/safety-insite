...
//     `HAZLENZ_CURATED_STANDARDS` (8 records) and `STANDARDS_INTELLIGENCE_SEED`
...
export const V1_JURISDICTIONS: JurisdictionEntry[] = [
  {
    ...
    corpusSource: 'governed source set (HAZLENZ_CURATED_STANDARDS + STANDARDS_INTELLIGENCE_SEED)',
    ...
    runtimeAvailability: 'materializes via `npm run seed:hazlenz-standards` (measured)',
...
export const RUNTIME_VERIFICATION = {
  standardsMasterMaterialization: 'VERIFIED — 35 records, manifest 14a34fea…, via npm run seed:hazlenz-standards',
