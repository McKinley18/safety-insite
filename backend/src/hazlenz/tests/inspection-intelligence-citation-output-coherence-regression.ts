...
function scopesFor(result: ReturnType<HazLenzReasoningOrchestratorService['reason']>): string[] {
...
pass('needs-more-evidence remains family coherent', needs.output.needsMoreEvidenceStandards.every((standard) => /^(29 CFR )?1910\.(303|305|306|331|333|334)|^(29 CFR )?1926\.(403|404|405)|^(30 CFR )?(56|57)\.(12004|12013|12016|12032|12034|12037)|electrical/i.test(`${standard.citation} ${standard.title || ''}`)) && !needs.output.needsMoreEvidenceStandards.some((standard) => /1910\.1200|1910\.177|1910\.178|1910\.179|1910\.180|1910\.184|1910\.218|1910\.502|crane|derrick|pit|rim wheel|slings|forging|hazcom|compressed gas|healthcare/i.test(`${standard.citation} ${standard.title || ''}`)), needs.output.needsMoreEvidenceStandards);
