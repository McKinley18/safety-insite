...
function humanText(result: ReturnType<HazLenzReasoningOrchestratorService['reason']>): string {
...
function commonPass(result: ReturnType<HazLenzReasoningOrchestratorService['reason']>): boolean {
  const intelligence = result.inspectionIntelligence;
...
const controlledCases: Array<{ name: string; observation: string; siteType?: string; suppressed: HazLenzReasoningDomain[] }> = [
...
const vagueCases: Array<{ name: string; observation: string; expectedDomain: HazLenzReasoningDomain }> = [
...
const jurisdictionCases: Array<{ name: string; observation: string; siteType?: string; expected: HazLenzJurisdiction; mineDetected: boolean }> = [
...
const mixedCases: Array<{ name: string; observation: string; siteType: string; primary: HazLenzReasoningDomain; suppressed: HazLenzReasoningDomain }> = [
