import {
  HazLenzRegulatoryApplicabilityInput,
  HazLenzRegulatoryApplicabilityOutput,
  HazLenzRegulatoryApplicabilityProfile,
  HazLenzRegulatoryApplicabilityStatus,
  HazLenzRegulatoryApplicabilityConfidence,
...
export class HazLenzRegulatoryApplicabilityService {
  evaluate(input: HazLenzRegulatoryApplicabilityInput): HazLenzRegulatoryApplicabilityOutput {
  ...
  private getProfileConfidence(
    status: HazLenzRegulatoryApplicabilityStatus,
    supportingCount: number,
    missingCount: number,
  ): HazLenzRegulatoryApplicabilityConfidence {
  ...
  private getRecommendedUse(status: HazLenzRegulatoryApplicabilityStatus): string {
