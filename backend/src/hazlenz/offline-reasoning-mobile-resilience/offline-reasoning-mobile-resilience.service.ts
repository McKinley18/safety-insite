...
export class OfflineReasoningMobileResilienceService {
  ...
  private readonly advisoryBoundary = 'HazLenz offline reasoning is advisory only and utilizes limited local knowledge summaries. Results are not final until verified online.';
