...
import { HazLenzFeedback } from './hazlenz-feedback.entity';
import { CreateSafeScopeFeedbackDto } from './create-feedback.dto';

@Injectable()
export class HazLenzFeedbackService {
  constructor(
    @InjectRepository(HazLenzFeedback)
    private readonly repo: Repository<HazLenzFeedback>,
  ) {}
