...
import { HazLenzFeedbackService } from './hazlenz-feedback.service';
import { CreateSafeScopeFeedbackDto } from './create-feedback.dto';

@Controller('hazlenz/feedback')
export class HazLenzFeedbackController {
  constructor(
    private readonly service: HazLenzFeedbackService,
  ) {}
