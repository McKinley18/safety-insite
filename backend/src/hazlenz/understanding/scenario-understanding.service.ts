import {
  HazLenzUnderstanding,
  HazLenzUnderstandingMechanismCandidate
} from './hazlenz-understanding.types';

export type HazLenzScenarioUnderstandingCandidate = {
  scenarioId: string;
  hazardFamily: string;
  mechanism: string;
  confidence: number;
...
export type HazLenzScenarioUnderstandingResult = {
  candidates: HazLenzScenarioUnderstandingCandidate[];
  topScenario?: HazLenzScenarioUnderstandingCandidate;
  evidenceGaps: string[];
};

export class ScenarioUnderstandingService {
  evaluate(understanding: HazLenzUnderstanding): HazLenzScenarioUnderstandingResult {
    const candidates: HazLenzScenarioUnderstandingCandidate[] = [];
  ...
  private addConveyorCleanupCandidate(
    candidates: HazLenzScenarioUnderstandingCandidate[],
    u: HazLenzUnderstanding,
    mechanism?: HazLenzUnderstandingMechanismCandidate
  ) {
  ...
  private hasGuardingFailure(u: HazLenzUnderstanding): boolean {
    return (
