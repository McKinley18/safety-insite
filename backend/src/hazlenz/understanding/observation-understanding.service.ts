import {
  ...
  HazLenzUnderstandingJurisdiction,
...
export class ObservationUnderstandingService {
  ...
  evaluate(rawText: string): HazLenzUnderstanding {
    ...
    const baseUnderstanding: HazLenzUnderstanding = {
  ...
  private detectJurisdiction(text: string): HazLenzUnderstandingJurisdiction {
  ...
  private inferMechanismCandidates(input: {
    ...
    const candidates: HazLenzUnderstandingMechanismCandidate[] = [];
