import { HazLenzEnergyType, HazLenzUnderstandingEnergy } from './hazlenz-understanding.types';

export class EnergyUnderstandingService {
  evaluate(normalizedText: string): HazLenzUnderstandingEnergy {
    const sources: HazLenzEnergyType[] = [];
    const reasons: string[] = [];

    const add = (source: HazLenzEnergyType, reason: string) => {
