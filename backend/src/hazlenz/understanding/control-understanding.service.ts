import {
  HazLenzControlHierarchyLevel,
  HazLenzUnderstandingControls
} from './hazlenz-understanding.types';

export class ControlUnderstandingService {
  evaluate(normalizedText: string): HazLenzUnderstandingControls {
    ...
    let strongestControlLevel: HazLenzControlHierarchyLevel = 'unknown';
