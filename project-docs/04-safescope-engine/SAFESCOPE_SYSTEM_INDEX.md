...
| Hazard Universe | Formal hazard/energy mapping registry | backend/src/safescope-v2/hazard-universe/ | N/A | backend/scripts/validate-safescope-hazard-universe-coverage-v1.ts | Universe v1 | Active | Intelligence foundation |
...
| Regulatory Audit & Ingestion | Automated source comparison and ingestion | backend/src/safescope-v2/regulatory-source-audit/ | safescope-data/source-audit/ | backend/scripts/validate-safescope-regulatory-source-audit-ingestion-v1.ts | Ingestion v1 | Active | Content pipeline |
...
| Coverage Matrix | Deterministic coverage audit | backend/src/safescope-v2/regulatory-source-audit/regulatory-coverage-matrix.service.ts | safescope-data/source-audit/ | backend/scripts/validate-safescope-regulatory-coverage-matrix-v1.ts | Matrix v1 | Active | Governance layer |
| Metadata Normalization | Deterministic draft mapping | backend/src/safescope-v2/regulatory-source-audit/regulatory-metadata-normalization.service.ts | safescope-data/source-audit/ | backend/scripts/validate-safescope-regulatory-metadata-normalization-v1.ts | Metadata v1 | Active | Knowledge preparation |
| Site Policy Isolation | Workspace/Site specific policy overlay | backend/src/safescope-v2/site-policy-isolation/ | safescope-data/site-policies/ | backend/scripts/validate-safescope-site-policy-isolation-v1.ts | Isolation v1 | Active | Governance layer |
| Core Regulatory Expansion | Source-backed expansion pack v1 | safescope-data/approved-knowledge/draft-candidates/ | N/A | backend/scripts/validate-safescope-core-regulatory-expansion-v1.ts | Expansion v1 | Active | Knowledge ingestion |
| Draft Promotion | Governed promotion service | backend/src/safescope-v2/regulatory-source-audit/regulatory-draft-promotion.service.ts | safescope-data/approved-knowledge/registry/ | backend/scripts/validate-safescope-core-regulatory-draft-promotion-workflow-v1.ts | Promotion v1 | Active | Governance layer |
