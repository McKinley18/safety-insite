...
Goal:
Implement SafeScope Approved Knowledge Retrieval Output v1.
...
10. Archive this prompt under:
    project-docs/09-archive-reference/prompts/SAFESCOPE_APPROVED_KNOWLEDGE_RETRIEVAL_OUTPUT_V1_PROMPT.md
