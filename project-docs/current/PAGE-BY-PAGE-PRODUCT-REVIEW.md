...
| **O-30** | HazLenz step, every visit | `GET /expert-analyses/current` returns 402 on a Free account and the client asks anyway, on 64 of 64 visits | **NOT FIXED — D-045.** The product decision is S-15's |
