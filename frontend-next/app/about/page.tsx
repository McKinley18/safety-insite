          ...
          <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-base font-semibold leading-7 text-slate-600 sm:text-lg sm:leading-8">
                AuditAlly helps teams turn field observations into documented findings, risk review, standards support, corrective action, and inspection-ready records.
              </p>
            </div>
        ...
        <div className="grid gap-5 border-b border-slate-200/80 py-7 sm:py-9 lg:grid-cols-[0.62fr_1.38fr] lg:items-start">
          ...
          <div className="border-l border-slate-200/80 pl-4">
            <p className="text-base font-semibold leading-7 text-slate-600">
              A safety finding should not disappear into a notebook, photo gallery, spreadsheet, or email chain. AuditAlly keeps the finding, evidence, review, and action connected so teams can move faster, communicate clearly, and follow through with confidence.
            </p>
