      ...
      <section className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-sm">
        ...
        >
          <input
            ...
            className="min-h-11 rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm font-semibold text-slate-900 outline-none transition focus:border-[#1D72B8]"
          ...
          <select
            ...
            className="min-h-11 rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm font-black text-slate-800 outline-none transition focus:border-[#1D72B8]"
          >
          ...
          <button
            ...
            className="min-h-11 rounded-xl bg-[#102A43] px-5 py-2 text-sm font-black text-white transition hover:bg-[#1D72B8] disabled:opacity-60"
          >
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      {[
                        ...
                        .map((tag: string) => (
                          <span
                            key={tag}
                            className="rounded-full bg-white px-3 py-1 text-[10px] font-black uppercase tracking-wide text-slate-500"
                          >
                            {tag}
                          </span>
                        ))}
