  ...
  return (
    <section className="space-y-4">
      ...
      <AppPanel padding="md" className="rounded-[24px] p-5 sm:p-5">
        <h2 className="text-xl font-black text-slate-900">Governed Knowledge Status</h2>
        ...
        <div className="mt-6 p-4 bg-amber-50 border border-amber-200 rounded-xl text-sm font-bold text-amber-800">
          <p>⚠️ Governance: Advisory Only. Does not declare violations. Does not create citations. Requires qualified review. Unapproved records do not affect active retrieval.</p>
        </div>
        <a href="/safescope-knowledge/review" className="mt-4 inline-block bg-blue-600 text-white px-4 py-2 rounded-lg font-bold">Review Queue</a>
      </AppPanel>
