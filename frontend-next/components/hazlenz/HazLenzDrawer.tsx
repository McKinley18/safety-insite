...
export default function HazLenzDrawer({
  title,
  summary,
  badge,
  children,
  ...
  return (
    <details className="mt-3 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 py-3">
