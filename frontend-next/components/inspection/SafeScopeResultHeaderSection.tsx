          ...
          {safeScopeResult.reasoningSnapshotId && (
            <div className="mt-3 border-t border-slate-200 pt-3">
              <button
                ...
                className="rounded-xl bg-white px-3 py-2 text-xs font-black text-[#1D72B8] ring-1 ring-slate-200 transition hover:bg-slate-100"
              >
                ...
                <div className="mt-3 rounded-xl bg-white px-3 py-3 ring-1 ring-slate-200">
                  <div className="grid gap-2 sm:grid-cols-2">
                    <p className="text-xs font-semibold leading-5 text-slate-600">
                      ...
                      {snapshotSummary.validationStatus || "unknown"}
                    </p>
                    ...
                    <p className="text-xs font-semibold leading-5 text-slate-600">
                      ...
                      {snapshotSummary.classification || "unknown"}
                    </p>
                    ...
                    <p className="text-xs font-semibold leading-5 text-slate-600">
                      ...
                      {formatSnapshotMode(
                        snapshotSummary.equipmentReasoningSummary
                  ...
                  <p className="mt-2 rounded-lg bg-slate-50 px-3 py-2 text-[11px] font-bold leading-5 text-slate-500">
                    Snapshot summaries are advisory, context-only, and require
                    qualified review. Raw snapshot retrieval remains separate
                    for deeper audit review.
                  </p>
                </div>
              )}
            </div>
