        ...
        {safeScopeStandardsOpen && (
          <div className="mt-4 border-t border-slate-100 dark:border-slate-800 pt-3">
            ...
            {questions.length > 0 ? (
              ...
              <p className="text-xs text-slate-500 font-semibold">No questions available.</p>
            )}
            <p className="mt-4 text-[10px] leading-normal text-slate-500 border-t border-slate-100 dark:border-slate-800/40 pt-2 font-semibold">
          ...
          {primaryStandards.length > 0 && (
            <div className="space-y-1">
              {supportingStandards.length > 0 && (
                <h4 className="mb-2 text-xs font-black uppercase tracking-wide text-slate-500 dark:text-slate-400">
