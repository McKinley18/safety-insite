      ...
      <div className="rounded-2xl border border-[#102A43] bg-[#102A43] p-5 text-white shadow-sm">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button
            ...
            className="rounded-xl bg-[#102A43] px-4 py-2.5 text-xs font-black text-white shadow-sm transition hover:bg-[#1D72B8] active:scale-[0.98] disabled:cursor-not-allowed disabled:bg-slate-300"
          >
            Generate
          </button>
        </div>
