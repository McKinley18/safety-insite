...
import { getHazLenzReasoningSnapshot } from "@/lib/hazlenzClient";
...
export default function HazLenzResultHeaderSection({
  safeScopeResult,
  submitHazLenzValidation,
}: Props) {
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            {[
              ...
              <button
                key={decision}
                type="button"
                onClick={() => submitHazLenzValidation(decision as any)}
