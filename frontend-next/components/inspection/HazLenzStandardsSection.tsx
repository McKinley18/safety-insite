...
type Props = {
  ...
  setHazLenzStandardsOpen: (updater: any) => void;
};

export default function HazLenzStandardsSection({
  safeScopeResult,
  feedbackNotes,
  setFeedbackNotes,
  selectedStandards,
  ...
  if (isVague) {
    ...
    return (
      <div className="mb-3 rounded-2xl border border-slate-200 bg-white px-4 py-3 text-slate-950 shadow-sm dark:border-white/10 dark:bg-[#0B1320] dark:text-white">
        <button
          type="button"
          onClick={() => setHazLenzStandardsOpen((open: boolean) => !open)}
        ...
        >
          ...
          <span className="shrink-0 rounded-full bg-slate-100 px-3 py-1 text-xs font-black text-slate-700 dark:text-slate-300">
            {hazLenzStandardsOpen ? "Hide" : "View Questions"}
          </span>
        </button>
  ...
  return (
    <div className="mb-3 rounded-2xl border border-slate-200 bg-white px-4 py-3 text-slate-950 shadow-sm dark:border-white/10 dark:bg-[#0B1320] dark:text-white">
      ...
      >
        ...
        <span className="shrink-0 rounded-full bg-slate-100 px-3 py-1 text-xs font-black text-slate-700 dark:text-slate-300">
          {hazLenzStandardsOpen ? "Hide" : "Review"}
        </span>
      </button>
