    ...
    <AppPanel padding="md" className="text-center">
      ...
      >
        ...
        <span>
          ...
          <span className="mt-1 block text-xs font-semibold leading-5 text-slate-700 dark:text-white">
      ...
      {!humanReviewConfirmed && (
        <p className="mt-2 text-[11px] font-bold text-slate-700 dark:text-white">
