type Props = {
  ...
  setHazLenzDetailsOpen: (updater: any) => void;
};
...
export default function HazLenzSupportingIntelligenceSection({
  safeScopeResult,
  hazLenzDetailsOpen,
  ...
  return (
    <div className="mb-3 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-3 shadow-sm">
      <button
        type="button"
        onClick={() => setHazLenzDetailsOpen((open: boolean) => !open)}
