...
import HazLenzControlsSection from "@/components/inspection/HazLenzControlsSection";
import HazLenzReasoningPanel from "@/components/inspection/HazLenzReasoningPanel";
import HazLenzResultHeaderSection from "@/components/inspection/HazLenzResultHeaderSection";
import HazLenzPrimaryDecisionSection from "@/components/inspection/HazLenzPrimaryDecisionSection";
import HazLenzStandardsSection from "@/components/inspection/HazLenzStandardsSection";
import HazLenzSupportingIntelligenceSection from "@/components/inspection/HazLenzSupportingIntelligenceSection";
import HazLenzKnowledgeBrainSection from "@/components/inspection/HazLenzKnowledgeBrainSection";
import HazLenzEquipmentReasoningSection from "@/components/inspection/HazLenzEquipmentReasoningSection";
import type {
...
type HazLenzInspectionStepProps = {
...
export default function HazLenzInspectionStep({
  hazLenzHelpOpen,
  setHazLenzHelpOpen,
  agencyMode,
  riskProfileId,
  ...
  return (
    <>
      ...
      {hazLenzStatus && !safeScopeResult && hazLenzStatus.includes("Running") && (
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                <button
                  type="button"
                  onClick={() => handleRunHazLenz(false)}
      ...
      {safeScopeResult && (
        <div className="mb-2 border-y border-slate-200 dark:border-slate-800 py-2">
          <HazLenzResultHeaderSection
            safeScopeResult={safeScopeResult}
            submitHazLenzValidation={submitHazLenzValidation}
          />

          <HazLenzPrimaryDecisionSection safeScopeResult={safeScopeResult} />
          ...
          <HazLenzEquipmentReasoningSection safeScopeResult={safeScopeResult} />
          ...
          {Array.isArray(safeScopeResult?.clarifyingQuestions) && safeScopeResult.clarifyingQuestions.length > 0 && (
            <div className="mb-2 rounded-2xl border border-amber-200 bg-amber-50 p-3 shadow-sm dark:border-amber-900/40 dark:bg-amber-950/20">
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2">
                <button
                  type="button"
                  onClick={() => handleRunHazLenz(
                    false,
                    safeScopeResult?.structuredObservation,
                    hazLenzClarificationAnswers,
                  )}
                  disabled={!hazLenzClarificationAnswers.length || hazLenzStatus.includes("Running")}
      ...
      <HazLenzSupportingIntelligenceSection
        safeScopeResult={safeScopeResult}
