...
type HazLenzObservationUnderstandingSectionProps = {
  safeScopeResult: any;
};
...
export default function HazLenzObservationUnderstandingSection({
  safeScopeResult,
}: HazLenzObservationUnderstandingSectionProps) {
