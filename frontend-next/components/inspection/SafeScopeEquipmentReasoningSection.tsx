...
export default function SafeScopeEquipmentReasoningSection({
  ...
  return (
    <section className="mb-4 rounded-2xl border border-slate-200 bg-white p-3 shadow-sm">
      ...
      <p className="mt-3 rounded-xl bg-slate-50 px-3 py-2 text-xs font-bold leading-5 text-slate-600 ring-1 ring-slate-200">
        SafeScope equipment reasoning is context-only and advisory. It does not
