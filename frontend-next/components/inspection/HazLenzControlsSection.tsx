...
import type { StructuredObservationInput } from "@/lib/hazlenzClient";

type Props = {
  hazLenzHelpOpen: boolean;
  setHazLenzHelpOpen: (updater: any) => void;
  agencyMode: string;
  riskProfileId: "simple_4x4" | "standard_5x5" | "advanced_6x6";
  handleRunHazLenz: (forceOffline?: boolean, structuredObservation?: StructuredObservationInput) => void;
...
export default function HazLenzControlsSection({
  hazLenzHelpOpen,
  setHazLenzHelpOpen,
  agencyMode,
  riskProfileId,
  ...
  return (
    <section className="mb-4 rounded-2xl border border-[#102A43] bg-[#102A43] p-5 text-white shadow-sm">
      <div className="flex items-start justify-between gap-3">
        ...
        <button
          type="button"
          onClick={() => setHazLenzHelpOpen((open: boolean) => !open)}
      ...
      <div className="mt-4 text-center">
        <button
          ...
          onClick={() => {
            ...
            handleRunHazLenz(false, buildStructuredObservation());
          }}
