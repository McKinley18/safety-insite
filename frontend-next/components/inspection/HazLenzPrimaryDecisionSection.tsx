...
export default function HazLenzPrimaryDecisionSection({
  safeScopeResult,
}: Props) {
  const riskLabel =
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <div className="mt-2 flex flex-wrap gap-2">
            <span className="rounded-full bg-slate-100 px-3 py-1 text-[11px] font-black uppercase tracking-wide text-slate-700 dark:text-slate-200">
        ...
        {mechanismChain && (
          <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 p-3">
            ...
            <div className="mt-2 grid gap-2 sm:grid-cols-2">
              <p className="text-xs font-semibold leading-5 text-slate-800 dark:text-slate-100">
