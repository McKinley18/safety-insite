          ...
          <div key={groupLabel}>
            ...
            <div className="mt-2 space-y-2">
              {groupEvents.length ? (
                ...
                <p className="priority-work-empty calendar-light-box rounded-lg border border-dashed border-slate-300 bg-slate-50 px-3 py-2 text-xs font-semibold text-slate-600">
                  Nothing here.
                </p>
              )}
            </div>
