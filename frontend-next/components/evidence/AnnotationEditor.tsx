...
import { AnnotationShapeRenderer } from "./AnnotationShapeRenderer";

export type DragMode = "move" | "resize" | "arrowStart" | "arrowEnd" | "draw" | "createRect" | "createCircle" | "createArrow" | null;
