...
import { HazLenzIntelligenceResult, HazLenzNarrative, NarrativeMode } from '../types';
...
export type HazLenzDisplayAdapter = {
  ...
  narrative: HazLenzNarrative | null;
};

export const createDisplayAdapter = (
  result: HazLenzIntelligenceResult,
  mode: 'simple' | NarrativeMode
): HazLenzDisplayAdapter => {
